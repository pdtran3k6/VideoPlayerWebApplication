...
@Component({
    ...
    <div id="thumbScrubber" (mousedown)="videoService.dragStart($event)" [style.top.px]="videoService.calculatedScrubY - 2" [style.left.px]="videoService.calculatedWidth + 2"></div>
    `
})
